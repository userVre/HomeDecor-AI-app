...
**Verification depth scales with `asvs_level`** (see @C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
