...
The keys live in `.claude/settings.json` (project) or `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
