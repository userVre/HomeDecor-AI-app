...
<!-- For checkpoint task examples and patterns, see @C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/references/checkpoints.md -->
...
See `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/workflows/verify-phase.md` for verification logic.
