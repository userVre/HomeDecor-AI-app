...
- Usage: Reference from command with `@C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
