...
INSTALL_JS_GLOBAL="C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
