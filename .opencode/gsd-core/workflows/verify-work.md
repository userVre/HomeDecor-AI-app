...
<template>
@C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/workflows/transition.md`.
...
- Follow @C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/workflows/diagnose-issues.md
