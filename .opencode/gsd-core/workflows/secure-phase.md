...
```
Agent(
  prompt="Read C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/templates/SECURITY.md`
