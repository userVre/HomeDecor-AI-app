...
- **Global scope**: `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/notes/`)
...
2. Glob `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/notes/` — works in any directory
