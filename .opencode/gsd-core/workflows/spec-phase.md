...
ones). Reference: @C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/templates/spec.md.
