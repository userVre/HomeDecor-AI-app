...
<required_reading>
@C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/references/ai-frameworks.md
@C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/agents/gsd-eval-planner.md for instructions.
