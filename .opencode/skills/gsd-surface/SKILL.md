...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/.gsd-surface.json`
(sibling to `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/skills`).
...
`C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/.gsd-surface.json`
Install profile marker: `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/.gsd-profile`
Skill dirs: `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/skills/gsd-*/`
Engine module: `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/LENOVO/Desktop/HomeDecor AI (Web-App)/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
